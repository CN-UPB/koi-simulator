...
for m = 1:n_c
    ...
    fprintf(fh, '%0.16f ',transpose(mpc(m).pos_BS));
    fprintf(fh, '%0.16f ',transpose(mpc(m).pos_MS));
    fprintf(fh, '%0.16f ',real(mpc(m).a_mpc));
    fprintf(fh, '%0.16f ',imag(mpc(m).a_mpc));
end