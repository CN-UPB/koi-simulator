...
for i in range(0, args.n):
    ...
    f.write("do\n");
    f.write("  tmp=\"-n 1 ./lteWrapper.sh par48cells12LP " + str(i) + " $x -c par48cells12LP --use-thread-pool=false --parallel-simulation=true\"\n");
    f.write("  if [ \"$x\" -ne 0 ];\n");
    f.write("   then\n");
    f.write("   cmd=\"$cmd : $tmp\"\n");
    f.write("   else\n");
