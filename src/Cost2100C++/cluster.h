...
public:
	...
	Cluster() {}
	//! Default constructor
	Cluster(const CLUSTER_TYPE c_type, const vec &c_bs_pos, const vec &c_ms_pos, const vec &spread, double c_sf, double c_tau_link, const vec &angle, int id);
		//! Default constructor
	Cluster(const CLUSTER_TYPE c_type, const vec &c_bs_pos, const vec &c_ms_pos, const vec &spread, double c_sf, double c_tau_link, const vec &angle, int id, MPC mpcs);
	//! Destructor
	virtual ~Cluster() {}
